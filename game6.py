...
class Game6():
    def __init__(self):
        ...
        self.secret_word = words.english_6L[random.randint(0, len(words.english_6L) - 1)]
    ...
    def check_words(self):
        for row in range(0, self.turn):
            ...
            # build color array
            letter_colors = [self.LETTER_INCORRECT] * 6
    ...
    def check_events(self):
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_RETURN and not self.game_over and self.letters == 6:  # restrict to 6 letters to move to next line
                    if self.in_wordlist():
    ...
    def in_wordlist(self):
        ...
        return the_word in words.english_6L
